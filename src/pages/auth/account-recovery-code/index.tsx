...
import { accountRecoveryCodeStyle } from "./accountRecoveryCodeStyle";
...
function accountRecovery() {
  ...
  return (
    <Box sx={{ ...accountRecoveryCodeStyle } as SxProps}>
        ...
        <Box className="innerBoxWrapper">
          <Box className="formWrapper">
            ...
            <Box className="bottomItem">
              <Link href="#">I dont have my phone</Link>
